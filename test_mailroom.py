...
def test_generate_donor_list():
    ...
    A serpreate donor list is included here to test seperately.
...
def test_current_donor():
    '''
    This test is to ensure that the current donor used will have thier
...
def test_draft_email():
    '''
    This test is to ensure that the draft email contians the correct name and amount
    '''
